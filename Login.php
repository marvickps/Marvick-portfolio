        ...
        <div class="row g-0">
            ...
            <?php
                  ...
                  <h4 class=" mb-4 pb-1">Login to your account</h4>
                        ...
                        <form action="login.php" method="post">
                            ...
                            <div class="form-outline mb-2">
                                <input class="btn btn-own" type="submit" name="Submit" id="submit" placeholder="Password" value="Login"  style="background-color: #e06c57; color:white; font-weight:600">
                            </div>
                        </form>
                    </div>
                </div>
              ...
              <div class="text-white px-3 py-4 p-md-5 mx-md-4  ">
                <h4 class="mb-4">BCA 6th Semester Project, 2022</h4>
                <p class="small mb-0">The Project is based on portfolio site with integrated dynamic Blog posting system. Created by Meraj Alam, Student of Tinsukia College.</p>
              </div>
              </div>
            </div>
            </div>
        ...
        <div class="container">
            <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
              <div class="col-md-4 d-flex align-items-center">
                ...
                <span class="text-muted">© MARVICK, 2022</span>
              </div>
